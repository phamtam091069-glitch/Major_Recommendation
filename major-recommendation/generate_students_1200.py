...
GROUPS = {
    ...
    "Xa hoi - Nhan van - Giao duc - Luat": {
        ...
        "muc_tieu_nghe_nghiep": ["On dinh", "Cong hien xa hoi", "Trien khai quoc te", "Trai nghiem quoc te"],
    },
...
KEYWORDS = {
    ...
    "Xa hoi - Nhan van - Giao duc - Luat": ["giao tiep", "ngon ngu", "luat", "giang day", "tam ly", "truyen thong", "phien dich"],
...
for item in majors:
    ...
    for i in range(20):
        ...
        if major == "Quay phim - Dung phim":
            profile_major = "quay phim va dung phim"
        else:
            profile_major = major.lower()
